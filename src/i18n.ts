...
const JA: Dict = {
  ...
  'readout.center': '中央',
  'readout.seam': '裂け目',
  'seam.interrupted': '複数 (断裂)',
  'lon.fixed': 'この図法は中央経線が 0° に固定 (断裂の位置が設計の一部)',
...
const EN: Dict = {
  ...
  'readout.seam': 'Seam',
  'seam.interrupted': 'several (interrupted)',
  'lon.fixed': 'This projection fixes the central meridian at 0° (the interruptions are part of the design)',
  ...
  'family.lenticular': 'Lenticular (modified azimuthal)',
