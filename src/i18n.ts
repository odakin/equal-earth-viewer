...
const JA: Dict = {
  ...
  'lat.north': '北緯 {n}°',
  'lat.south': '南緯 {n}°',
  'drag.hint.oblique': '地図をドラッグ (スワイプ) して中心を上下左右に動かせます。ホイール / ピンチで拡大、ダブルクリック (ダブルタップ) で戻ります。',
  'preset.americas': 'アメリカ',
  'preset.americas.lon': '西経90°',
  'preset.pacific': '太平洋',
  'preset.pacific.lon': '東経150°',
  'preset.europe': 'ヨーロッパ・アフリカ',
  'spin.start': '回す',
  'spin.stop': '停止',
  'drag.hint': '地図を左右にドラッグ (スワイプ) しても回せます。ホイール / ピンチで拡大、ダブルクリック (ダブルタップ) で戻ります。',
  'panel.view.aria': '表示の設定',
  'proj.label': '図法',
  'toggle.graticule': '経緯線',
  'toggle.tissot': 'ティソーの指示楕円',
  'toggle.countries': '国 (色分け・国名)',
  'toggle.south': '南を上に',
  'export.svg': 'SVG を保存',
...
const EN: Dict = {
  ...
  'panel.lon.aria': 'Map view',
  'preset.label': 'Map center',
  'options.label': 'Rotation and display',
  ...
  'lat.north': '{n}°N',
  'lat.south': '{n}°S',
  'drag.hint.oblique': 'Drag (swipe) the map to move the center in any direction. Wheel / pinch to zoom, double-click (double-tap) to reset.',
  'preset.americas': 'Americas',
  'preset.americas.lon': '90°W',
  'preset.pacific': 'Pacific',
  'preset.pacific.lon': '150°E',
  'preset.europe': 'Europe & Africa',
  'spin.start': 'Spin',
  'spin.stop': 'Stop',
  'drag.hint': 'You can also drag (swipe) the map sideways. Wheel / pinch to zoom, double-click (double-tap) to reset.',
  'panel.view.aria': 'Display settings',
  'proj.label': 'Projection',
  'toggle.graticule': 'Graticule',
  'toggle.tissot': "Tissot's indicatrix",
  'toggle.countries': 'Countries (colored, named)',
